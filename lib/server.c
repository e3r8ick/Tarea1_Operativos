...
if (size > 0)
  ...
  //colores
  int color;
  color = racist("images/B.bmp");
  if(color == 1){
    char array_charR[800];
    strcpy(array_charR,"outputImages/R/B.bmp");
    strcat(array_charR,filename);
    rename (array_charR,"outputImages/R/B.bmp");
  }
  else if(color == 2){
    char array_charG[800];
    strcpy(array_charG,"outputImages/G/B.bmp");
    strcat(array_charG,filename);
    rename (array_charG, "outputImages/G/B.bmp");
  }else{
    char array_charB[800];
    strcpy(array_charB,"outputImages/B/B.bmp");
    strcat(array_charB,filename);
    rename (array_charB,  "outputImages/B/B.bmp");
  }
